...
export default {
  setup() {
    ...
    const items = [
      { title: 'Wilson Blade Feel 100 Raqueta Multifunción', img: 'raqueta1.jpeg', price: '89,99' },
      { title: 'Raqueta Tenis Babolat Evo Drive', img: 'raqueta2.jpeg', price: '95,99' },
      { title: 'Bote de pelotas WILSON US Open Bote B3', img: 'wilson-us-open-bote-b3.jpg', price: '4,90' },
      { title: 'Muñequeras Performance 7,5 cm para hombre - Pack', img: 'muñeq.jpeg', price: '10' },
    ]
