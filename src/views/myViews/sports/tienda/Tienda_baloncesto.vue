...
export default {
  setup() {
    ...
    const items = [
      { title: 'NBA DRV Plus Wilson', img: 'bola_bask.webp', price: '24,95' },
      { title: 'Estudiantes 2022-33 Puma', img: 'cami_bask.webp', price: '49,95' },
      { title: 'Jet 21 Under Armour', img: 'botas_bask.webp', price: '56' },
      { title: 'Giannis Immortality 2', img: 'zapas_bask.webp', price: '84,99' },
    ]
